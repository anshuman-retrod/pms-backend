...
from apps.accounts.models import AppUser, AccountLock, LoginAttempt, UserSession, UserMFA
...
from apps.monitoring.serializers import SystemHealthSnapshotSerializer, SystemMetricSerializer
