...
from apps.features.reservations.services import BookingEngine, RoomAssignmentEngine, CheckInCheckOutEngine
...
class ReservationEngineTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        from apps.features.inventory.models import InventoryUnitCategory
