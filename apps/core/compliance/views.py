...
from apps.core.compliance.models import ConsentRecord, RetentionPolicy, GDPRRequest
from apps.core.compliance.serializers import ConsentRecordSerializer, RetentionPolicySerializer, GDPRRequestSerializer
