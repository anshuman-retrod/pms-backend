...
class BuildingFloorAPITests(APITestCase):
    def setUp(self):
        ...
        from apps.rbac.models import Role, UserPropertyRole
...
class InventoryCloneTests(APITestCase):
    def setUp(self):
        from apps.accounts.models import AppUser
        from apps.rbac.models import Role, UserPropertyRole, Permission, RolePermission
        from apps.rates.models import RatePlan, RatePlanInventoryType, RateRuleOccupancy, CancellationPolicy, ChildPolicy
    ...
    def test_clone_success(self):
        ...
        from apps.rates.models import RatePlanInventoryType
    ...
    def test_transaction_rollback(self):
        ...
        with patch('apps.inventory.models.InventoryUnitAttribute.objects.create', side_effect=IntegrityError("Simulated DB failure during cloning attributes")):
            response = self.client.post(f'/api/inventory/types/{self.source_type.id}/clone/', {
